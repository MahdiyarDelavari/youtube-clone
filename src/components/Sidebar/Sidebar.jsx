...
const Sidebar = ({sidebar}) => {
	return (
		<div className={ `sidebar border-r-2 border-gray-200 bg-white w-[15%] h-[calc(100vh-70px)] overflow-y-auto pl-[2%] mt-[70px] pt-[20px] pb-[20px] fixed top-0 ${sidebar ? 'left-0' : '-left-80'} transition-left duration-1000`}>
